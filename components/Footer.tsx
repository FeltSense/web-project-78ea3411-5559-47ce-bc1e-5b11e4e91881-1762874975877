  ...
  <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24 lg:py-32">
    ...
    <div className="grid md:grid-cols-4 gap-8 md:gap-12 lg:gap-16 mb-12">
      ...
      <div className="md:col-span-1">
        <div className="text-white text-2xl font-bold mb-2">Include</div>
        <p className="text-gray-400 text-sm leading-relaxed">
          Bringing everything together for modern business success.
        </p>
        <div className="flex gap-4 mt-6">
          ...
          <a href="#" className="text-gray-400 hover:text-white transition-colors duration-200" aria-label="LinkedIn">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.475-2.236-1.986-2.236-1.081 0-1.722.722-2.004 1.418-.103.249-.129.597-.129.946v5.441h-3.554s.05-8.836 0-9.754h3.554v1.391c.43-.665 1.199-1.61 2.920-1.61 2.135 0 3.733 1.39 3.733 4.377v5.596zM5.337 8.855c-1.144 0-1.915-.759-1.915-1.71 0-.955.77-1.71 1.952-1.71 1.18 0 1.914.755 1.939 1.71 0 .951-.759 1.71-1.976 1.71zm1.946 11.597H3.392V9.698h3.891v10.754zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0z"/>
            </svg>
          </a>
        </div>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li><a href="#services" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">Consulting</a></li>
          <li><a href="#services" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">Integration</a></li>
          <li><a href="#services" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">Support</a></li>
          <li><a href="#services" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">Training</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          <div>
            ...
            <a href="mailto:hello@include.com" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm font-medium">
              hello@include.com
            </a>
          </div>
          <div>
            <p className="text-gray-400 text-sm">Phone</p>
            <a href="tel:+1234567890" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm font-medium">
              +1 (234) 567-890
            </a>
          </div>
        </div>
    ...
    {/* Bottom Section */}
    <div className="mt-12 pt-8 flex flex-col md:flex-row md:justify-between md:items-center gap-6">
